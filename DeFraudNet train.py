...
import sys
sys.path.append('/content/drive/My Drive/DeFraudNet')

# # from google.colab import drive
# # drive.mount('/content/drive/folders/18QgZk5MLEx7JFwR5FuAw1gZCkiTlowby')
# from google.colab import drive
# drive.mount('/content/drive/DeFraudNet_model.py')
# import sys
# sys.path.append('/content/drive/MyDrive/DeFraudNet')  # Adjust this path to your folder location
